...
const DIAGNOSTICS = {
  p2t: {
    ...
    items: [
      "Response time to inquiries — under 5 minutes is the target",
      "After-hours, weekend, and holiday coverage",
      "Scheduling friction — can prospects easily book a tour online?",
      "Lead source mix — are sources producing tourable prospects?",
      "Online reputation and review scores across major platforms",
      "Tour path condition, signage, and first impression on arrival",
    ],
  },
  t2a: {
  ...
  renewal: {
    ...
    items: [
      ...
      "Lease term flexibility (12, 9, 6 month options)",
  ...
  traffic: {
    ...
    items: [
      ...
      "Internet Listing Services (Apartments.com, Zillow, Rent.com) — listing quality and feature investment",
      "Paid digital advertising — Google Ads, Meta, retargeting performance",
      "Property website and SEO — organic search visibility for the local market",
      "Online reputation and review scores driving organic discovery",
      "Resident referral program — incentive structure and current participation",
      "Local marketing partnerships and outreach to corporate accounts and relocation services",
      "Property signage, drive-by visibility, and walk-in conversion",
    ],
  },
};
    ...
    <div className="wpg">
      ...
      <div className="wrap">
        ...
        {activeTab === "action-plan" && (() => {
          ...
          const targetW = (r.reachable && r.validRates) ? ceil(committedWeeklyGoal) : null;
          const cw = num(curWeekly);
