...
@media print {
  ...
  .wpg .hero .big {
    color: #044160 !important; font-size: 32pt !important;
    line-height: 1 !important; margin: 0.15rem 0 !important;
  }
  .wpg .hero .per {
    color: #1a4d70 !important; font-size: 9pt !important;
    margin-top: 0.2rem;
  }
  .wpg .hero .dt { color: #044160 !important; font-size: 8pt !important; }
  ...
  /* "Where's the Gap" verdict bullets — exploration content, hide */
  ...
  .wpg .funnel-card > *:not(.ph) { padding: 0.4rem 0.75rem !important; }
  .wpg .frow {
  ...
  .wpg .rm-kpi-status { white-space: nowrap; }
  ...
  /* Feasibility verdict — single line */
  .wpg .ph-feas {
    background: #eef3f7 !important;
    border-left: 3px solid #044160 !important;
    border-radius: 4px !important;
  ...
  /* Unchanged KPIs — 4-column table-style row, very compact */
  .wpg .improve-card.unchanged-card {
    background: transparent !important;
    border-top: 1px solid #b8c8d8 !important;
