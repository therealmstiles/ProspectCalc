...
/* Unchanged row: 5-column layout — name, value, benchmark, status, toggle */
.wpg .uc-row {
  display: grid !important;
  grid-template-columns: 1.6fr 0.7fr 1fr 1fr 28px;
  gap: 0.6rem;
  align-items: center;
}
.wpg .uc-benchmark {
...
@media print {
  /* ─────────────────────────────────────────────────────────────
     PRINT TYPOGRAPHY — single hierarchy, tight spacing.
     Display: 28pt · H1: 16pt · H2: 11pt · Body: 9.5pt · Small: 8pt
     COLORS
     #044160 navy (primary)   #1a4d70 mid-navy (body)
     #5b7a92 slate (subdued)  #b8c8d8 light-navy (borders)
     #eef3f7 pale-navy (backgrounds)
     ───────────────────────────────────────────────────────────── */
  ...
  /* Brand row + kicker — minimal header */
  .wpg .kicker {
  ...
  .wpg .brand-row { gap: 0.55rem !important; margin: 0 0 0.4rem !important; }
  .wpg .brandmark { width: 32px !important; height: 32px !important; }
  ...
  /* Property banner — concise context strip on print */
  .wpg .prop-banner {
  ...
  .wpg .rm-kpi-name { color: #1a4d70 !important; }
  .wpg .rm-kpi-val { color: #044160 !important; font-weight: 700; font-variant-numeric: tabular-nums; }
  .wpg .rm-kpi-bench { color: #5b7a92 !important; font-variant-numeric: tabular-nums; }

  /* Hero card — focused, single column */
  .wpg .hero {
    background: #fff !important;
    border: 1px solid #b8c8d8 !important;
  ...
  .wpg .hero .big {
    color: #044160 !important; font-size: 36pt !important;
    line-height: 1 !important; margin: 0.2rem 0 !important;
  }
  .wpg .hero .per {
    color: #1a4d70 !important; font-size: 9pt !important;
    margin-top: 0.3rem;
  }
  .wpg .hero .dt { color: #044160 !important; font-size: 8.5pt !important; }
  .wpg .hero .dv { color: #044160 !important; font-size: 10pt !important; }
  .wpg .hero .occ-strip {
    background: #eef3f7 !important;
  ...
  /* Funnel card — primary math output */
  .wpg .funnel-card {
    background: #fff !important;
    border: 1px solid #b8c8d8 !important;
    box-shadow: none !important;
  ...
  .wpg .funnel-card > *:not(.ph) { padding: 0.5rem 0.85rem !important; }
  .wpg .frow {
  ...
  .wpg .frow .fval { color: #044160 !important; font-size: 10.5pt !important; font-weight: 700; }
  .wpg .frow .frate { color: #5b7a92 !important; font-size: 7.5pt !important; }
  .wpg .stat .sl { color: #044160 !important; font-size: 7.5pt !important; }
  .wpg .stat .sv { color: #044160 !important; font-size: 13pt !important; }

  /* Force calculator grid to be single column on print */
  .wpg .grid {
  ...
  /* "How It Computes" methodology — only on Calculator tab */
  .wpg .note {
    background: #eef3f7 !important;
    border: 1px solid #b8c8d8 !important;
    border-left: 3px solid #044160 !important;
  ...
  .wpg .plan-head {
    ...
    padding: 0 !important; margin: 0 0 0.6rem !important;
  }
  .wpg .prepared-strip {
    display: block !important;
    border-bottom: 1px solid #b8c8d8;
    padding-bottom: 0.4rem; margin-bottom: 0.55rem !important;
    font-size: 9pt !important;
  }
  .wpg .prepared-strip .prepared-on,
  .wpg .prepared-strip .prepared-by { display: inline !important; }
  .wpg .prepared-on {
    color: #044160 !important; letter-spacing: 0.08em;
    font-weight: 700; text-transform: uppercase;
    font-size: 8.5pt !important;
  }
  .wpg .prepared-by { margin-left: 0 !important; }
  .wpg .prepared-by::before {
    content: "  ·  ";
  ...
  /* The two WPG number boxes — side by side, equal heights, equal padding */
  .wpg .ph-numbers {
    display: grid !important;
  ...
  .wpg .ph-num-val {
    color: #044160 !important; font-size: 24pt !important;
    line-height: 1 !important; font-weight: 800;
  }
  .wpg .ph-num-val small {
    color: #5b7a92 !important; font-size: 8.5pt !important;
    font-weight: 500; margin-left: 0.3rem;
  }
  .wpg .ph-num-hint {
    color: #5b7a92 !important; font-size: 7.5pt !important;
  ...
  /* Committed Improvements — numbered list, compact */
  .wpg .plan-section {
  ...
  .wpg .plan-section-head h2 {
    color: #044160 !important; font-size: 11pt !important;
    text-transform: uppercase; letter-spacing: 0.08em;
    border-bottom: 1.5px solid #044160; padding-bottom: 0.15rem;
    margin: 0 !important;
  }
  ...
  /* Each improvement: numbered, compact, no card chrome */
  .wpg .improve-card {
    background: transparent !important;
    border: none !important;
  ...
  .wpg .improve-card .ic-title {
    color: #044160 !important; font-size: 10.5pt !important; font-weight: 700;
  }
  ...
  .wpg .ic-from { color: #5b7a92 !important; font-size: 9.5pt !important; }
  .wpg .ic-to { color: #044160 !important; font-size: 10.5pt !important; font-weight: 700; }
  .wpg .ic-arrow { color: #5b7a92 !important; }
  .wpg .ic-delta {
    background: #eef3f7 !important; color: #044160 !important;
    font-size: 7.5pt !important; padding: 0.08rem 0.35rem !important;
  }

  /* Benchmark reference line on committed cards */
  .wpg .ic-benchmark {
    color: #1a4d70 !important;
    font-size: 8.5pt !important;
  ...
  /* Hide the diagnostic exercise — that happened in the meeting */
  ...
  /* Action items as the deliverable text */
  .wpg .action-print {
    display: block !important;
    background: transparent !important;
    border: none !important;
    padding: 0.15rem 0 0 1.1rem !important;
    color: #1a4d70 !important;
    font-size: 9.5pt !important;
  ...
  /* Unchanged KPIs — table-style row with benchmark and status columns */
  .wpg .improve-card.unchanged-card {
    background: transparent !important;
    border-top: 1px solid #b8c8d8 !important;
  ...
  .wpg .uc-row {
    ...
    display: grid !important;
    grid-template-columns: 1.8fr 0.7fr 1fr 1.1fr !important;
    gap: 0.5rem !important;
    align-items: baseline;
  }
  .wpg .uc-name { color: #044160 !important; font-size: 9.5pt !important; font-weight: 600; }
  .wpg .uc-val { color: #044160 !important; font-size: 9.5pt !important; font-weight: 700; font-variant-numeric: tabular-nums; }
  .wpg .uc-benchmark { color: #5b7a92 !important; font-size: 8.5pt !important; font-variant-numeric: tabular-nums; }
  .wpg .uc-status { font-size: 8.5pt !important; font-weight: 600; font-variant-numeric: tabular-nums; }
  .wpg .uc-status.ok { color: #15803d !important; }
  .wpg .uc-status.miss { color: #b91c1c !important; }
  /* Show notes if present, hide checklist + section labels */
  .wpg .improve-card.unchanged-card .uc-body {
    display: block !important;
    padding: 0.2rem 0 0 !important;
  }

  /* Inputs/labels (just in case any panels leak through) */
  .wpg input {
    background: #fff !important;
    border: 1px solid #b8c8d8 !important;
    color: #044160 !important;
          ...
          <div className="rm-summary-grid">
            ...
            <div className="rm-col rm-kpi">
              ...
              <div className="rm-kpi-row">
                <span className="rm-kpi-name">Team Capacity</span>
                <span className="rm-kpi-val">{num(staffCount) * WEEKLY_LEADS_PER_AGENT} a week</span>
                <span className="rm-kpi-bench">{num(staffCount)} staff × {WEEKLY_LEADS_PER_AGENT}</span>
                <span className="rm-kpi-status" />
              </div>
            </div>
          </div>
