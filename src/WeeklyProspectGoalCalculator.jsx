...
/* Property + period banner — single contextual bar below the header */
.wpg .prop-banner {
  display: flex; flex-wrap: wrap; align-items: baseline;
  gap: 0.6rem; padding: 0.8rem 1.1rem;
...
@media print {
  /* ─────────────────────────────────────────────────────────────
     PRINT TYPOGRAPHY HIERARCHY — single, simple, predictable.
     Display: 28pt  — big WPG numbers and hero
     H1:      18pt  — page title
     H2:      12pt  — section headers
     Body:    10pt  — paragraph text, action items
     Small:    8pt  — captions, dates, footnote
     ─────────────────────────────────────────────────────────────
     COLORS
     #044160 navy (primary)   #1a4d70 mid-navy (body)
     #5b7a92 slate (subdued)  #b8c8d8 light-navy (borders)
  ...
  .wpg .actions, .wpg .save-pip, .wpg .tabs { display: none !important; }
  ...
  .wpg .brand-row { gap: 0.6rem !important; margin: 0 0 0.4rem !important; }
  .wpg .brandmark { width: 36px !important; height: 36px !important; }
  .wpg .brandmark img { filter: none !important; }
  .wpg .brand-row h1 {
    font-size: 18pt !important; color: #044160 !important;
    margin: 0 !important; line-height: 1.15 !important;
  }
  .wpg h1 .accent { color: #2cb1cc !important; }

  /* The narrative subtitle does not belong on either printed output */
  .wpg .sub { display: none !important; }
  ...
  .wpg .prop-banner-sep { color: #5b7a92 !important; }

  /* ─── ACTION PLAN TAB PRINT LAYOUT ─── */

  /* Plan header — compact prepared strip + side-by-side WPG numbers */
  .wpg .plan-head {
    background: transparent !important; border: none !important;
    padding: 0 !important; margin: 0 0 0.9rem !important;
  }
  .wpg .prepared-strip {
    border-bottom: 1px solid #b8c8d8;
    padding-bottom: 0.45rem; margin-bottom: 0.7rem !important;
    font-size: 9pt !important;
  }
  .wpg .prepared-on { color: #044160 !important; letter-spacing: 0.08em; font-weight: 700; }
  .wpg .prepared-by-lab { color: #044160 !important; }
  .wpg .prepared-by-input { display: none !important; }
  .wpg .prepared-by-print {
    display: inline !important; font-size: 9pt;
    color: #044160 !important; font-weight: 600;
    margin-left: 0.3rem;
  }

  /* The two WPG number boxes — side by side, equal heights */
  .wpg .ph-numbers {
  ...
  .wpg .ph-num {
    ...
    border: 1px solid #b8c8d8 !important;
    border-left: 3px solid #5b7a92 !important;
  ...
  .wpg .ph-num-val {
    color: #044160 !important; font-size: 26pt !important;
    line-height: 1 !important; font-weight: 800;
  }
  .wpg .ph-num-val small {
    color: #5b7a92 !important; font-size: 9pt !important;
    font-weight: 500; margin-left: 0.3rem;
  }
  .wpg .ph-num-hint {
    color: #5b7a92 !important; font-size: 8pt !important;
    font-style: italic; margin-top: 0.25rem;
  }

  /* Feasibility verdict — single emphatic sentence */
  .wpg .ph-feas {
    background: #eef3f7 !important;
    border-left: 3px solid #044160 !important;
  ...
  /* Committed Improvements — numbered list, compact, no inner card chrome */
  .wpg .plan-section {
  ...
  .wpg .plan-section-head { margin-bottom: 0.5rem !important; }
  .wpg .plan-section-head h2 {
    color: #044160 !important; font-size: 12pt !important;
  ...
  .wpg .plan-empty {
    ...
    color: #5b7a92 !important; font-size: 10pt !important;
    padding: 0.6rem 0.8rem !important;
  }

  /* Each improvement: number + title + change strip + action items */
  .wpg .improve-card {
    background: transparent !important;
    border: none !important;
  ...
  .wpg .improve-card .ic-title {
    color: #044160 !important; font-size: 11pt !important; font-weight: 700;
  }
  ...
  .wpg .ic-from { color: #5b7a92 !important; font-size: 10pt !important; }
  .wpg .ic-to { color: #044160 !important; font-size: 11pt !important; font-weight: 700; }
  .wpg .ic-arrow { color: #5b7a92 !important; }
  .wpg .ic-delta {
    background: #eef3f7 !important; color: #044160 !important;
    font-size: 8pt !important; padding: 0.1rem 0.4rem !important;
  }

  /* Hide the operational areas exercise — that work happened in the meeting */
  ...
  /* The action items are the deliverable — render as the static text body */
  .wpg .action-print {
    display: block !important;
    background: transparent !important;
    border: none !important;
    padding: 0.2rem 0 0 1.2rem !important;
  ...
  .wpg .action-print i { color: #5b7a92 !important; font-style: italic; }

  /* Unchanged KPIs — keep as a compact list, no exercise content */
  .wpg .improve-card.unchanged-card {
    background: transparent !important;
    border-top: 1px solid #b8c8d8 !important;
  ...
  .wpg .uc-name { color: #044160 !important; font-size: 10pt !important; font-weight: 600; }
  .wpg .uc-val { color: #1a4d70 !important; font-size: 10pt !important; }
  /* Show the body so notes appear, but hide the checklist */
  .wpg .improve-card.unchanged-card .uc-body { display: block !important; padding: 0.2rem 0 0 !important; }

  /* ─── CALCULATOR TAB PRINT LAYOUT ─── */
  ...
  .wpg .hero .big {
    color: #044160 !important; font-size: 42pt !important;
    line-height: 1 !important;
  }
  .wpg .hero .per {
    color: #1a4d70 !important; font-size: 10pt !important;
    margin-top: 0.4rem;
  }
  .wpg .hero .dt { color: #044160 !important; font-size: 9pt !important; }
  .wpg .hero .dv { color: #044160 !important; font-size: 11pt !important; }
  .wpg .hero .occ-strip {
    background: #eef3f7 !important;
  ...
  .wpg .hero .occ-strip .occ-cap,
  .wpg .hero .occ-strip .occ-arrow { color: #5b7a92 !important; }

  /* "Where's the Gap" is exploration content — not for stakeholders */
  .wpg .hero-diag { display: none !important; }

  /* Panels — uniform navy header band, no decoration */
  .wpg .panel {
    background: #fff !important;
    border: 1px solid #b8c8d8 !important;
    box-shadow: none !important;
  ...
  .wpg .panel .ph h2 { color: #fff !important; font-size: 10pt !important; }
  .wpg .panel .ph .tag {
    color: #fff !important;
    background: rgba(255,255,255,0.15) !important;
    font-size: 7.5pt !important;
  }
  .wpg .panel > *:not(.ph) { padding: 0.7rem 0.9rem !important; }
  .wpg .panel > *:not(.ph):not(:last-child) { padding-bottom: 0 !important; }

  /* Force calculator grid to single column so panels read top-to-bottom cleanly */
  .wpg .grid { grid-template-columns: 1fr !important; gap: 0.75rem !important; }
  .wpg .rcol { display: flex; flex-direction: column; }
  .wpg .funnel-card { order: -1; margin-bottom: 0.75rem; }

  /* Inputs and form fields on print — clean, no shadows */
  .wpg input {
    background: #fff !important;
    border: 1px solid #b8c8d8 !important;
    color: #044160 !important;
  ...
  .wpg .hint { color: #5b7a92 !important; font-size: 8pt !important; }
  .wpg .derived { color: #1a4d70 !important; font-size: 9pt !important; }
  .wpg .derived b { color: #044160 !important; }

  /* Sliders hidden, values shown */
  .wpg .lever .llab { color: #044160 !important; font-size: 9pt !important; }
  .wpg .lever .lrefs { color: #5b7a92 !important; font-size: 8pt !important; }
  .wpg .lever .lval {
    background: transparent !important;
    color: #044160 !important;
    padding: 0 !important;
  ...
  /* Funnel cascade and stats */
  .wpg .frow { padding: 0.3rem 0 !important; }
  .wpg .frow .flab { color: #1a4d70 !important; font-size: 9pt !important; }
  .wpg .frow .fval { color: #044160 !important; font-size: 11pt !important; }
  .wpg .frow .frate { color: #5b7a92 !important; font-size: 8pt !important; }
  .wpg .stat .sl { color: #044160 !important; font-size: 8pt !important; }
  .wpg .stat .sv { color: #044160 !important; font-size: 14pt !important; }
  .wpg .fcap {
    color: #044160 !important; font-size: 9pt !important;
    letter-spacing: 0.08em;
  }

  /* "How It Computes" methodology — keep on Calculator print only */
  .wpg .note {
    background: #eef3f7 !important;
    border: 1px solid #b8c8d8 !important;
    border-left: 3px solid #044160 !important;
  ...
  .wpg .note p { margin: 0 0 0.4rem !important; }
  .wpg .note ul { margin: 0 0 0.5rem !important; padding-left: 1rem; }
  ...
  /* KPIs Below Target list */
  .wpg .miss .lab { color: #044160 !important; font-size: 8pt !important; }
  .wpg .miss li { color: #1a4d70 !important; font-size: 9.5pt !important; }
  .wpg .miss li .meta { color: #5b7a92 !important; font-size: 8.5pt !important; }
  .wpg .miss li .pip { background: #b91c1c !important; }
  .wpg .bar { background: #eef3f7 !important; }
  .wpg .bar > span { background: #044160 !important; }

  /* Page break controls */
  .wpg .improve-card, .wpg .plan-head, .wpg .panel, .wpg .hero { page-break-inside: avoid; }
        ...
        <div className="head">
          <div className="title-block">
            ...
            <div className="brand-row">
              <img className="brandmark" src={LOGO_SRC} alt="Birchstone" />
